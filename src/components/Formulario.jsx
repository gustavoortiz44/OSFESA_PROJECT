...
import { sweetAlert, sweetAlertError } from "../../sweetalert2/Alerta"
...
const Formulario = () => {
    ...
    const handleSubmit = async e => {
        e.preventDefault()
        if ([usuarioId, nombreUsuario, passwordUser, levelUser, estatusUser].includes('')) {
            return sweetAlertError()
        }

        try {

            await fetch(`${import.meta.env.VITE_BACKEND_URL}/crearUsuario.php`, {
                method: "POST",
                headers: {
        ...
        <>
            ...
            <form className='bg-white py-6 px-5 md:w-1/2 rounded-lg shadow-lg mt-0  shadow-zinc-300' onSubmit={handleSubmit}>
                ...
                <div className="mb-3 p-3">
                    <label htmlFor="userId" className='text-gray-700 uppercase font-bold text-center'>UsuarioId:</label>
                    <input type="text"
                ...
                <div className="mb-3 p-3">
                    <label htmlFor="nombre" className='text-gray-700 uppercase font-bold text-center'>Nombre de Usuario:</label>
                    <input type="text"
                ...
                <div className="mb-3 p-3">
                    <label htmlFor="level" className='text-gray-700 uppercase font-bold text-center'>Nivel:</label>
                    <input type="text"
                ...
                <div className="mb-3 p-3">
                    <label htmlFor="status" className='text-gray-700 uppercase font-bold text-center'>Status:</label>
                    <input type="text"
                ...
                <div className="mb-3 p-3">
                    <label htmlFor="password" className='text-gray-700 uppercase font-bold text-center'>Password:</label>
                    <input type="password"
